...
#		end
#	end
#	puts "Skipped #{existing customers_count} already existing customer#{"s" if existing customers_count != 1}.
#				Added #{added_customers_count} new customer#{"s" if added_customers_count != 1}!"
#end
#
